...
import com.example.jiamoufang.tutorialapp.adapter.CommentAdapter;
import com.example.jiamoufang.tutorialapp.adapter.LoveAdapter;
...
public class PostDetailsActivity extends ParentWithNaviActivity implements PostDetailsView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //如果当前发帖用户的头像为Null，则加载默认头像
        //否则根据URL请求
        if (mPost.getAuthor().getAvatar() == null)
            Glide.with(this).load(R.mipmap.default_ss).into(mIvUserAvatar);
        else
