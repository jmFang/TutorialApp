            ...
            BmobIM.connect(user.getObjectId(), new ConnectListener() {
                ...
                public void done(String s, BmobException e) {
                    if (e == null) {
                        ...
                        //BmobIM.getInstance().updateUserInfo(new BmobIMUserInfo(user.getObjectId(), user.getUsername(),user.getMoreInfo() == null? null:user.getMoreInfo().getObjectId()));
                    } else {
                        toast(e.getMessage());
                    }
                }
